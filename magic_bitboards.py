...
ROOK_MAGICS = [
    ...
    0x0000204000808000, 0x0000200040008080, 0x0000100080004080, 0x0000080080002080,
    0x0000040080001080, 0x0000020080000880, 0x0000010080000480, 0x0000008080000280,
    0x0000804000800020, 0x0000402000401000, 0x0000801000200080, 0x0000800800100080,
    0x0000800400080080, 0x0000800200040080, 0x0000800100020080, 0x0000800040800100,
    0x0000208000400080, 0x0000404000201000, 0x0000808010000800, 0x0000808008000400,
    0x0000808004000200, 0x0000808002000100, 0x0000808001000100, 0x0000408000800100,
    0x0000204000808000, 0x0000200040008080, 0x0000100080004080, 0x0000080080002080,
...
def get_bishop_attacks(square, occupancy):
    ...
    magic_index = (relevant_occupancy * BISHOP_MAGICS[square]) >> (64 - BISHOP_RELEVANT_BITS[square])
